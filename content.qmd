...
A course on data analysis through a GIS, both applied skills in ArcGIS Pro and QGIS, as well as the theory underlying common data analysis workflows. This was the course that produced the most maps, with deliverables like the ones below also developing the underappreciated skill of making a good-looking map. Particularly interesting to me was the early emphasis on familiarity with relational database management, PostGIS databases, and GDAL, the building blocks of geographic information systems that many GIS courses I had taken previously glossed over or never mentioned. I appreciated the deeper understanding of how to directly interface with databases without relying on the comfortable interface of a GIS.
